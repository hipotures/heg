...
<label><span><input type="checkbox" name="fail_closed" checked> Fail closed</span><small>Stop on infrastructure, security, protocol, resource, or model-contract failure. Invalid independent measurement arms are retained and later independent arms continue.</small></label></div></fieldset>
