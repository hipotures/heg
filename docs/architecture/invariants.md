...
| Exact facts/current executable IDs are non-droppable | memory projection and complete-request compaction before final Director limit | forced-compaction, request-budget and SnapshotBuilder ordering tests | `scientific_state_overflow` |
